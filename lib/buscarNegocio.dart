...
class buscarNegocioCategoria extends StatefulWidget {
  const buscarNegocioCategoria({Key? key}) : super(key: key);

  @override
  _buscarNegocioCategoriaState createState() => _buscarNegocioCategoriaState();
}

class _buscarNegocioCategoriaState extends State<buscarNegocioCategoria> {
...
class buscarDato extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Stream<QuerySnapshot> consultar=FirebaseFirestore.instance.collection("Negocio").where('Categoria' ,isEqualTo:informacion).snapshots();
